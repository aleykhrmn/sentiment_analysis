...
Conv1D ve MaxPooling1D Katmanları: Bu katmanlar, metin verisindeki önemli özellikleri çıkarır ve boyutunu azaltır. 
Bu sayede model daha hızlı ve verimli çalışır.
GlobalMaxPooling1D: Bu katman, her filtre için maksimum değeri alarak 1D vektör oluşturur.
Dropout Katmanı: Aşırı öğrenmeyi önlemek için kullanılır.
Dense Katmanları: Son katman, softmax aktivasyon fonksiyonu ile sınıflandırma yapar.
Bu kod, metin sınıflandırma görevini CNN kullanarak gerçekleştirir ve sonuçları 
değerlendirmek için doğruluk oranını ve sınıflandırma raporunu sağlar.
